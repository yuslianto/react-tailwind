    ...
    <div className={`navbar fixed w-full transition-all ${scrollActive}`}>
      <div className="container mx-auto px-4">
        <div className="navbar-box flex items-center justify-between">
          <div className="logo">
            <h1 className="sm:text-2xl text-xl font-bold">Fun#Code</h1>
          </div>
          <ul
            className={`flex lg:gap-12 md:static md:flex-row md:bg-transparent md:w-auto md:h-full md:translate-y-0 md:text-black md:shadow-none md:p-0 md:m-0 md:transition-none iapd:gap-8 gap-4 fixed ${menuActive} top-1/2 -translate-y-1/2 flex-col px-8 py-6 rounded shadow-lg shadow-slate-300 bg-sky-400 text-white transition-all`}
          >
          ...
          <div className="social flex items-center gap-2">
            <a
              href="#social-link"
              className="bg-sky-400 px-3 py-2 text-sm ipad:px-5 rounded-full text-white font-bold hover:bg-sky-500 transition-all"
            >
              Social Media
            </a>
            <i
